...
namespace Daenet.ServiceBus.NetCore
{
    ...
    internal class DeadLetterMessagingSamples
    {
        ...
        public static async Task RunAsync(int numberOfMessages)
        {
            ...
            Console.WriteLine("Press any key to start poison messages receiver...");
            Console.ReadKey();
        ...
        {
            // Process the message.
            Console.WriteLine($"Received POISON message: SequenceNumber:{message.SystemProperties.SequenceNumber} Body:{Encoding.UTF8.GetString(message.Body)}");
